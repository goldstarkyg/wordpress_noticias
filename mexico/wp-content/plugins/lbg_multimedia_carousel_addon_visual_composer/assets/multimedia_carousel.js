    window.VcMultimediaCarouselView = vc.shortcode_view.extend({
        ...
        render:function () {
            window.VcMultimediaCarouselView.__super__.render.call(this);
        ...
        changeShortcodeParams:function (model) {
            window.VcMultimediaCarouselView.__super__.changeShortcodeParams.call(this, model);
        ...
        addTab:function (e) {
			...
			vc.shortcodes.create({shortcode:'multimedia_carousel_playlist_item', params:{title:'Playlist Item - NEW'}, parent_id:this.model.id});
        },
        _loadDefaults:function () {
            window.VcMultimediaCarouselView.__super__._loadDefaults.call(this);
        }
    });