...
class WPBakeryShortCode_youtube_vimeo_playlist_item extends WPBakeryShortCode_VC_Tab {
	...
	public function contentAdmin( $atts, $content = null ) {
		...
		for ( $i = 0; $i < count( $width ); $i ++ ) {
			...
			$output .= '<div class="group wpb_sortable youtube_vimeo_playlist_item_class">';
			$output .= '<h3><span class="tab-label" style="padding-left:30px;"><%= params.title %></span> &nbsp; <%= params.youtube %> </h3>     <div data-element_type="vc_playlist_item" class="vc_playlist_item">';
