    window.VcYoutubeVimeoView = vc.shortcode_view.extend({
        ...
        render:function () {
            window.VcYoutubeVimeoView.__super__.render.call(this);
        ...
        changeShortcodeParams:function (model) {
            window.VcYoutubeVimeoView.__super__.changeShortcodeParams.call(this, model);
        ...
        addTab:function (e) {
			...
			vc.shortcodes.create({shortcode:'youtube_vimeo_playlist_item', params:{title:'Playlist Item - NEW'}, parent_id:this.model.id});
        },
        _loadDefaults:function () {
            window.VcYoutubeVimeoView.__super__._loadDefaults.call(this);
        }
    });