...
class WPBakeryShortCode_universal_video_player_playlist_item extends WPBakeryShortCode_VC_Tab {
	...
	public function contentAdmin( $atts, $content = null ) {
		...
		for ( $i = 0; $i < count( $width ); $i ++ ) {
			...
			$output .= '<div class="group wpb_sortable univp_playlist_item_class">';
