...
$boombox_show_media          = apply_filters( 'boombox/loop-item/show-media', ( $boombox_template_options['media'] && $boombox_has_post_thumbnail ), $boombox_template_options['media'], $boombox_has_post_thumbnail, 'content-grid' );
...
do_action( 'boombox/loop-item/before-content', 'content-grid' ); ?>
...
<?php do_action( 'boombox/loop-item/after-content', 'content-grid' ); ?>