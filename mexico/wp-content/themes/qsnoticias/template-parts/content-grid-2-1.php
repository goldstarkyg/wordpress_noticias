...
$boombox_show_media          = apply_filters( 'boombox/loop-item/show-media', ( $boombox_template_options['media'] && $boombox_has_post_thumbnail ), $boombox_template_options['media'], $boombox_has_post_thumbnail, 'content-grid-2-1' );
...
do_action( 'boombox/loop-item/before-content', 'content-grid-2-1' ); ?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $boombox_post_classes ); ?>>
    ...
    <div class="post-thumbnail">
        ...
        <?php if ( apply_filters( 'boombox/loop-item/show-badges', $boombox_template_options['badges'] ) ) {
...
<?php do_action( 'boombox/loop-item/after-content', 'content-grid-2-1' ); ?>