...
$boombox_listing_type    = apply_filters( 'boombox_search_result_listing_type', 'list' );
$boombox_pagination_type = apply_filters( 'boombox_search_result_pagination_type', 'page' );
...
<div class="container">
	<header class="page-header">
		<?php printf( '<span>%1$s</span> <h1 class="page-title">%2$s</h1>',
			esc_html__( 'Resultados encontrados para: ', 'boombox' ),
