...
$boombox_show_media                     = apply_filters( 'boombox/loop-item/show-media', ( $boombox_template_options['media'] && ( $boombox_has_post_thumbnail || $boombox_featured_video ) ), $boombox_template_options['media'], ( $boombox_has_post_thumbnail || $boombox_featured_video ), 'content-classic' );
...
do_action( 'boombox/loop-item/before-content', 'content-classic' ); ?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $boombox_post_classes ); ?>>
	...
	<div class="post-thumbnail">
		...
		if ( $boombox_show_media ) {
			...
			if (!$boombox_is_nsfw_post && $boombox_full_post_button_label) { ?>
...
<?php do_action( 'boombox/loop-item/after-content', 'content-classic' ); ?>